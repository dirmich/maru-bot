...
export const translations = {
  en: {
    ...
    mac_step_1: "1. Download the .zip or .pkg for your architecture.",
  ...
  ko: {
    ...
    mac_step_1: "1. 아키텍처(Intel/Apple Silicon)에 맞는 .zip 또는 .pkg를 받으세요.",
  ...
  ja: {
    ...
    win_step_3: "3. トレイアイコンから管理画面にアクセスします。",
    mac_install: "macOS (Intel/Silicon)",
    mac_step_1: "1. CPUに合わせて.zipや.pkgをダウンロードします。",
  ...
  es: {
    ...
    mac_install: "macOS (Intel/Silicon)",
    mac_step_1: "1. Descarga el .zip o .pkg para tu arquitectura.",
