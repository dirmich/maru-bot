...
## ✨ 0.4.4 업데이트
- **GPIO 저장 네비게이션**: 웹 관리자에서 설정 저장 시 자동으로 목록 화면으로 전환됩니다.
- **AI 도구 실시간 동기화**: GPIO 설정 변경 사항이 AI 도구에 실시간으로 반영됩니다.
- **버전 표기 자동화**: AI가 자신의 버전을 더 정확하게 인식하도록 시스템 프롬프트 및 템플릿을 개선했습니다.
- **업그레이드 안정화**: 백그라운드 업그레이드 및 재시작 로직을 보완했습니다.
