...
- **2026-02-22**: 에이전트 자아 인식(Self-Awareness) 강화. 시스템 프롬프트에 버전(v0.4.0) 및 Webhook 활성화 정보 주입 완료.
- **2026-02-22**: 빌드 에러(`undefined: config`) 핫픽스 적용 및 재배포 완료.
- [x] 2026-02-22: AI 자아 인식 강화 및 정식 배포 완료.
