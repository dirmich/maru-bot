# MaruBot - Ultra-light AI Agent (0.7.5) ?¶û
...
### 4. ?ß† Smart Memory System (RAG Memory)
...
### 5. ?õ†Ô∏?Powerful Automation & Control Tools
...
### 6. ?åê Centralized Management & Landing Page
...
```
*?í° Even if connection to the primary model fails, it will automatically fallback if API keys for other providers exist!*
...
## ?ß© Extension Guide (Skills & Tools)
...
## ?õ†Ô∏?Hardware Integration Guide
